...
import 'package:meem_app/Modules/Service%20Provider/Order/Views/sp_order_summay_view.dart';
...
import '../../ViewModel/sp_order_list_view_model.dart';



class SpOrderListMobileView extends StatefulWidget {
  const SpOrderListMobileView({Key? key}) : super(key: key);
  static String id = 'sp_orderListScreen';

  @override
  State<SpOrderListMobileView> createState() => _SpOrderListMobileViewState();
}

class _SpOrderListMobileViewState extends State<SpOrderListMobileView> {
  final ScrollController _scrollController = ScrollController();

  late SpOrderListViewModel orderListViewModel;
  int _counter = 1;
  ...
  void initState() {
    orderListViewModel =
        Provider.of<SpOrderListViewModel>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    orderListViewModel = Provider.of<SpOrderListViewModel>(context, listen: true);
    return VisibilityDetector(
      key: Key(SpOrderListMobileView.id),
                      ...
                      ? InkWell(
                        onTap: (){
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      SpOrderSummaryView(product_id: orderListViewModel.orderListCoreModel!.order![index].orderNumber,)
                              ));
                        },
                        child: Padding(
