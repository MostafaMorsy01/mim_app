...
class SpOrderSummryCoreModel {
  List<OrderItem>? orderItem;
  String? address;
  String? paymentType;

  SpOrderSummryCoreModel({this.orderItem, this.address, this.paymentType});

  SpOrderSummryCoreModel.fromJson(Map<String, dynamic>? json) {
