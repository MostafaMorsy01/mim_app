...
class PaymentViewModel with ChangeNotifier {
  ...
  PaymentWebService webServices = PaymentWebService();
  ...
  Future<void> paymentMethodData(
    ...
    notifyListeners();
    print("start");
    APIResponse? response = await webServices.fetchPaymentMethod();
    print("message");
    ...
    if (response?.status == 200) {
      paymentCore = PaymentMethodCoreModel.fromJson(response?.data);
      print("dataa");
      print("done");
