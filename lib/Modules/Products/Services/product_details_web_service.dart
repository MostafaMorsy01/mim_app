...
class ProductsDetailsWebServices {

  String? _token;


  Future<APIResponse?> fetchProductsDetailsData(int? productId) async {
    ...
    try {
      response = await Dio().get(
        EndPoints.baseUrl + EndPoints.get_products_details +"/$productId" ,
        options: Options(
            headers: {
              'content-language':'ar',
